...
const includedRepoPackages: Package[] = [
  { name: 'Available package', summary: 'Apache HTTP Server', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'High performance web server', repository: 'included', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'PostgreSQL database server', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Docker container runtime', repository: 'included', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'IT automation tool', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Version control system', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Vi IMproved text editor', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Retrieve files from the web', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Transfer data from or to a server', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Python 3 programming language', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Secure Shell client and server', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'System and service manager', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Execute command as superuser', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Stream editor for filtering text', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Terminal multiplexer', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Trace system calls and signals', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'SMB/CIFS file and print server', repository: 'included', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Simple Network Management Protocol', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Web proxy cache', repository: 'included', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Mail transfer agent', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Apache web server', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Berkeley Internet Name Domain', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Bourne Again Shell', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Multi-call binary', repository: 'included', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Arbitrary precision calculator', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Block-sorting file compressor', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Container image builder', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Daemon for executing scheduled commands', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Common Unix Printing System', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Antivirus software', repository: 'included', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Disk encryption setup utility', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'DHCP server daemon', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Lightweight DNS forwarder', repository: 'included', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'IMAP and POP3 server', repository: 'included', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Intrusion prevention software', repository: 'included', source: 'Third Party Repository' },
  { name: 'Selected Package', summary: 'Selected Package', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'RADIUS server', repository: 'included', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'GNU Compiler Collection', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'GNU C Library', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'GNU Privacy Guard', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Load balancer and proxy', repository: 'included', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Apache HTTP Server tools', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Linux packet filtering', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Java Runtime Environment', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Linux kernel', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Virtualization library', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Log file rotation utility', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Database server', repository: 'included', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Memory caching daemon', repository: 'included', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Network monitoring system', repository: 'included', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Network utility', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Selected Package', summary: 'Selected Package', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'VPN solution', repository: 'included', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'PHP scripting language', repository: 'included', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Container engine', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Machine emulator and virtualizer', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'In-memory data structure store', repository: 'included', source: 'Third Party Repository' },
  { name: 'Selected Package', summary: 'Selected Package', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'RPM Package Manager', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Selected Package', summary: 'Selected Package', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Network packet analyzer', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Terminal multiplexer', repository: 'included', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Extract files from ZIP archives', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'HTTP accelerator', repository: 'included', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Network protocol analyzer', repository: 'included', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Extended Internet Services daemon', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Package manager', repository: 'included', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Z shell', repository: 'included', source: 'Red Hat Repository' },
];

const otherRepoPackages: Package[] = [
  { name: 'Available package', summary: 'Extra Packages for Enterprise Linux', repository: 'other', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Distributed search and analytics engine', repository: 'other', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Data visualization and exploration platform', repository: 'other', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Data processing pipeline', repository: 'other', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Metrics visualization and alerting', repository: 'other', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Monitoring system and time series database', repository: 'other', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'JavaScript runtime built on Chrome V8', repository: 'other', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Node.js package manager', repository: 'other', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Object-oriented programming language', repository: 'other', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Ruby package manager', repository: 'other', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Go programming language', repository: 'other', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Systems programming language', repository: 'other', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Rust package manager', repository: 'other', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Infrastructure as code tool', repository: 'other', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Machine image creation tool', repository: 'other', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Development environment manager', repository: 'other', source: 'Third Party Repository' },
  { name: 'Available package', summary: 'Configuration management tool', repository: 'other', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Configuration management platform', repository: 'other', source: 'Red Hat Repository' },
  { name: 'Available package', summary: 'Infrastructure management tool', repository: 'other', source: 'Third Party Repository' },
...
export const AdditionalPackages: React.FunctionComponent = () => {
  ...
  const [selectedPackages, setSelectedPackages] = React.useState<Set<string>>(new Set(['Selected Package']));
